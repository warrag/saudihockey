odoo.define('plustech_hr_leave.employee.dashboard.views', function(require) {
    'use strict';
    ...
    var TimeOffCalendarEmployeeController = CalendarController.extend({
        ...
        _getNewTimeOffContext: function() {
            ...
            date_from = date_from.lang("en").format('YYYY-MM-DD HH:mm:ss');
            ...
            date_to = date_to.lang("en").format('YYYY-MM-DD HH:mm:ss');
            return {
    ...
    viewRegistry.add('time_off_employee_calendar_lang_en', TimeOffCalendarEmployeeView);
});
